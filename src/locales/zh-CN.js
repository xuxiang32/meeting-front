export default {
  ...
  'app.analysis.user_list':'用户组',
  'app.analysis.single_users':'个人用户',
  'app.analysis.group_users':'部门用户',
  'app.analysis.channel.all': '全部渠道',
  'app.analysis.channel.online': '线上',
  'app.analysis.channel.stores': '门店',
  'app.analysis.channel.meet1':'会议室1',
  'app.analysis.channel.meet2':'会议室2',
